...
.config(['$routeProvider', function($routeProvider) {
	...
	.when('/primaryKeys/:databasePattern?/:tablePattern?',						{templateUrl: 'html/primary_keys.html', controller: 'consult'})
	.when('/importedKeys/:databasePattern?/:tablePattern?',						{templateUrl: 'html/imported_keys.html', controller: 'consult'})
